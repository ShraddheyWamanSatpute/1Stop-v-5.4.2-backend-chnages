    ...
    MuiTab: {
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          fontWeight: themeConfig.typography.fontWeightMedium,
          textTransform: 'none !important',
          borderTopLeftRadius: themeConfig.borderRadius,
          borderTopRightRadius: themeConfig.borderRadius,
          transition: 'background-color 0.2s ease, color 0.2s ease',
          // Default tab label color: readable on both light and dark surfaces
          color: theme.palette.text.secondary,
          '&:hover': {
            backgroundColor: alpha(themeConfig.colors.secondary.main, 0.10),
            color: themeConfig.brandColors.navy,
          },
          // Selected tab must be visible; in light mode offWhite is invisible on paper
          '&.Mui-selected': {
            color: theme.palette.mode === 'dark'
              ? theme.palette.text.primary
              : themeConfig.brandColors.navy,
            backgroundColor: alpha(themeConfig.colors.secondary.main, 0.16),
          },
        }),
      },
    },
    ...
    MuiTabs: {
      styleOverrides: {
        root: ({ theme }) => ({
          borderRadius: themeConfig.borderRadius,
          '& .MuiTabs-indicator': {
            // Use accent in light mode; keep bright indicator in dark mode
            backgroundColor: theme.palette.mode === 'dark'
              ? theme.palette.text.primary
              : themeConfig.brandColors.lightBlue,
          },
        }),
      },
    },
