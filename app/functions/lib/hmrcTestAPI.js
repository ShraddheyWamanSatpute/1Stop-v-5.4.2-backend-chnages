...
exports.testHMRCAPIConnection = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    ...
    try {
        ...
        console.log('Making HMRC API call:', {
            ...
            accessTokenLength: (effectiveAccessToken === null || effectiveAccessToken === void 0 ? void 0 : effectiveAccessToken.length) || 0,
        ...
        try {
            ...
            apiResponse = await fetch(endpoint, {
                method: 'GET',
                headers: Object.assign({ 'Authorization': `Bearer ${effectiveAccessToken}`, 'Accept': 'application/json' }, finalFraudHeaders),
