...
async function sendWithGmail(opts) {
    ...
    try {
        ...
        const snap = await admin_1.db.ref(userScopedPath || sharedPath).get();
        const cfg = (snap.val() || {});
        const email = String((cfg === null || cfg === void 0 ? void 0 : cfg.email) || "").trim();
        const appPassword = String((cfg === null || cfg === void 0 ? void 0 : cfg.appPassword) || "").trim();
        const senderName = String((cfg === null || cfg === void 0 ? void 0 : cfg.senderName) || "").trim();
...
exports.processEmailOutbox = (0, database_1.onValueCreated)({ ref: "admin/email/outbox/{outboxId}", region: "europe-west1" }, async (event) => {
...
exports.processEmailOutboxUser = (0, database_1.onValueCreated)({ ref: "admin/email/users/{userId}/outbox/{outboxId}", region: "europe-west1" }, async (event) => {
    const companyId = "admin";
