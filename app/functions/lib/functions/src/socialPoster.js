...
async function processOne(postId, post) {
    ...
    const credsSnap = await admin_1.db.ref(`admin/social/credentials`).get();
...
exports.onSocialPostCreated = (0, database_1.onValueCreated)("admin/social/posts/{postId}", async (event) => {
