...
exports.listEvents = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    ...
    try {
        ...
        const url = `https://graph.microsoft.com/v1.0/me/calendars/${encodeURIComponent(calendarId)}/events?` +
            `$top=100&$orderby=start/dateTime&$select=id,subject,bodyPreview,start,end,isAllDay,lastModifiedDateTime&$filter=${encodeURIComponent(filter)}`;
        ...
        const events = (data.value || []).map((ev) => {
            ...
            return ({
                ...
                start: ((_a = ev.start) === null || _a === void 0 ? void 0 : _a.dateTime) || "",
                end: ((_b = ev.end) === null || _b === void 0 ? void 0 : _b.dateTime) || "",
