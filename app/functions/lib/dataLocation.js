...
exports.handleLocationDataRequest = void 0;
...
const getSupabaseConfig = () => {
    ...
    if (!url || !serviceRoleKey) {
        throw Object.assign(new Error("Missing SUPABASE_URL or SUPABASE_SERVICE_ROLE_KEY for Location provider"), { status: 500 });
    }
...
const upsertLocation = async (scope, id, payload) => {
    ...
    if (!existing)
        await insertRow("app_locations", row);
    else
        await patchRow("app_locations", { id, base_path: scope.basePath }, row);
    return Object.assign(Object.assign({}, (row.payload || {})), { id });
};
const handleLocationDataRequest = async ({ req, res, path, body, user }) => {
    var _a;
    ...
    if (pathname === "/data/location/locations" && method === "POST") {
        ...
        const row = await upsertLocation(scope, id, (body === null || body === void 0 ? void 0 : body.data) || {});
    ...
    if (itemMatch && method === "PATCH") {
        ...
        const row = await upsertLocation(scope, id, (body === null || body === void 0 ? void 0 : body.updates) || {});
...
exports.handleLocationDataRequest = handleLocationDataRequest;
//# sourceMappingURL=dataLocation.js.map