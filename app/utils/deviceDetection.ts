...
/** iPhone, iPod, iPad, or iPadOS reporting as Mac touch. */
...
/** Any Android browser (phone or tablet). */
export const isAndroidUserAgent = (): boolean => {
  if (typeof navigator === "undefined") return false
  return /Android/i.test(navigator.userAgent)
}

/** Apple or Android device — used for PWA / “add to home” install prompts. */
export const isAppleOrAndroidDevice = (): boolean => isIOSFamily() || isAndroidUserAgent()

/** True when the app is already running as an installed PWA / home-screen app. */
export const isStandalonePWADisplay = (): boolean => {
