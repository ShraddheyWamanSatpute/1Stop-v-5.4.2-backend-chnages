...
const SESSION_DISMISS_KEY = "1stop_app_install_prompt_dismissed"
...
/**
 * On iOS/Android, encourages installing the 1Stop web app (PWA / Add to Home Screen).
 * Shown on every route under `/App` until dismissed for the session or already running standalone.
 */
const AppInstallPrompt: React.FC = () => {
  ...
  const appPath = `${window.location.origin}/App`
      ...
      <Stack direction="row" spacing={1.5} alignItems="flex-start">
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
            Add this app to your home screen for quicker access. It uses the{" "}
        ...
        <Stack direction="row" spacing={0.5} alignItems="center" sx={{ flexShrink: 0 }}>
          ...
          <IconButton size="small" aria-label="Dismiss install prompt" onClick={dismiss}>
